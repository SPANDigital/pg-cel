...
INSTALL_SCRIPTS = pg_cel--1.0.6.sql pg_cel--1.0.7.sql pg_cel--1.1.0.sql pg_cel--1.2.0.sql pg_cel--1.2.1.sql pg_cel--1.3.0.sql
# Upgrade scripts (version transitions)  
UPGRADE_SCRIPTS = pg_cel--1.0.6--1.0.7.sql pg_cel--1.0.7--1.1.0.sql pg_cel--1.1.0--1.2.0.sql pg_cel--1.2.0--1.2.1.sql pg_cel--1.2.1--1.3.0.sql
